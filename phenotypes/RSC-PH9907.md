...
Identification of new cases of acute bronchitis for the RCGP RSC weekly report of Respiratory and Communicable Diseases for England.

## Overview

The algorithm identifies the cohort of patients that have a new diagnosis event of acute bronchitis within the week of observation.
...
|-------------------------|-----------------|
|  _**disease-codelist**_ |   RSC-C7211    | 
